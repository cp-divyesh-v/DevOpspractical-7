# Practical - 27 - Contact Keeper App
...
Note - Write a Unit test for ViewModel. (If possible use Cuckoo)
- SwiftUI framework dosen't Support Cuckoo so I have write Unit Test case normally without using Cuckoo only.
